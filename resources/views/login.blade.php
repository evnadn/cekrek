...
<head>
    ...
    <title>Cekrek - Login</title>
</head>

<body>
    <div class="container">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 mb-4 text-center">Cekrek - Login</h4>
                <form>
                    ...
                    <p class="text-center">Belum mempunyai akun? <a href="{{ url('/register') }}">Daftar</a> </p>
                </form>
            </article>
    </div>
    <!--container end.//-->
