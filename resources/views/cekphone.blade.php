...
@section('title','Cekrek - Cek Telepon')
...
<div class="jumbotron text-center grey lighten-5 shadow-none">
    ...
    <div class="container">
        <!-- Title -->
        <h2 class="card-title h2">Cek Telepon</h2>
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-xl-7 pb-2">
                ...
                <p class="card-text">Identifikasi apakah suatu nomor telepon berpotensi melakukan penipuan.
                </p>
        ...
        <small>Contoh: <span class="text-info ">082183759242</span></small>
