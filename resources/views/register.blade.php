...
<head>
    ...
    <title>Cekrek - Register</title>
</head>

<body>
    <div class="container">
        <article class="card-body mx-auto" style="max-width: 400px;">
            <h4 class="card-title mt-3 mb-4 text-center">Cekrek - Buat Akun</h4>
            <form>
                ...
                <p class="text-center">Sudah mempunyai akun? <a href="{{ url('/login') }}">Login</a> </p>
            </form>
        </article>
</div>
<!--container end.//-->
